    ...
    <>
      ...
      <section className="premier-section">
        ...
        <div className="premier-content">
          ...
          <br />
          <p>
            Sabemos que relajarte en tu viaje es la mejor forma de disfrutarlo,
            es por ello que en nuestro Servicio Premier está diseñado para que
            su cuerpo descanse en una posición ideal.
            <br />
            <br />
            Nuestro bus cuenta con dos niveles con asientos ergonómicos en el
            1er nivel cama de 160° y en el 2do nivel con asientos full flat
            180°. Además, contarás con un puerto usb para tus dispositivos
            móviles.
          </p>
          <br />
